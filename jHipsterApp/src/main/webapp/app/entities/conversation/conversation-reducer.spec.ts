...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONVERSATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_CONVERSATIONS actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONVERSATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONVERSATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONVERSATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONVERSATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONVERSATION actions', async () => {
      const arg = 42666;
