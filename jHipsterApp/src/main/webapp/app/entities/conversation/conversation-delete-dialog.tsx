...
export const ConversationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/conversation${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="qMessagingApp.conversation.delete.question">
        <Translate contentKey="qMessagingApp.conversation.delete.question" interpolate={{ id: conversationEntity.id }}>
