...
import { deleteEntity, getEntity } from './message.reducer';
...
export const MessageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="qMessagingApp.message.delete.question">
        <Translate contentKey="qMessagingApp.message.delete.question" interpolate={{ id: messageEntity.id }}>
