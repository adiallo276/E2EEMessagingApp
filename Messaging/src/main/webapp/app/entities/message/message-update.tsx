  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="messageApp.message.home.createOrEditLabel" data-cy="MessageCreateUpdateHeading">
            <Translate contentKey="messageApp.message.home.createOrEditLabel">Create or edit a Message</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('messageApp.message.content')}
                id="message-content"
                name="content"
                data-cy="content"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('messageApp.message.ciphertext')}
              ...
              />
              <ValidatedField
                label={translate('messageApp.message.timestamp')}
              ...
              <ValidatedField
                ...
                label={translate('messageApp.message.conversation')}
                type="select"
              >
                <option value="" key="0" />
                {conversations
              ...
              <ValidatedField
                ...
                name="sender"
                data-cy="sender"
                label={translate('messageApp.message.sender')}
                type="select"
              >
                <option value="" key="0" />
                {users
