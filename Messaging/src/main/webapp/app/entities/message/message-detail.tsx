    ...
    <Row>
      <Col md="8">
        <h2 data-cy="messageDetailsHeading">
          <Translate contentKey="messageApp.message.detail.title">Message</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="messageApp.message.conversation">Conversation</Translate>
          </dt>
          <dd>{messageEntity.conversation ? messageEntity.conversation.id : ''}</dd>
          <dt>
            <Translate contentKey="messageApp.message.sender">Sender</Translate>
          </dt>
