    ...
    <Row>
      <Col md="8">
        <h2 data-cy="conversationDetailsHeading">
          <Translate contentKey="qMessagingApp.conversation.detail.title">Conversation</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="qMessagingApp.conversation.user1">User 1</Translate>
          </dt>
          <dd>{conversationEntity.user1 ? conversationEntity.user1.login : ''}</dd>
          <dt>
            <Translate contentKey="qMessagingApp.conversation.user2">User 2</Translate>
          </dt>
